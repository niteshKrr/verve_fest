...
const Diya_decoration = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    axios
      .post(`https://verve-fest.onrender.com/cultural/diya_decoration`, {
        name,
        branch,
        roll,
        batch,
      ...
      <Card className="sm:w-96">
        <CardHeader className="flex gap-4 my-3">
          ...
          <div className="flex flex-col">
            <p className="text-md font-bold">Register for Diya_decoration </p>
          </div>
        </CardHeader>
        <Divider />
        <CardBody>
...
export default Diya_decoration;
